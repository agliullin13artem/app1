...
class Order(models.Model):
    user = models.ForeignKey(to=User, on_delete=models.SET_DEFAULT, default=None, blank=True, null=True,  verbose_name='Пользователь')
...
#  какие имеено товары заказал пользователь
